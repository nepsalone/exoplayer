...
import com.itechneps.android.exoplayer2.util.EGLSurfaceTexture;
...
public final class DummySurface extends Surface {
  ...
  public static synchronized boolean isSecureSupported(Context context) {
    if (!secureModeInitialized) {
      secureMode = Util.SDK_INT < 24 ? EGLSurfaceTexture.SECURE_MODE_NONE : getSecureModeV24(context);
  ...
  @TargetApi(24)
  private static @EGLSurfaceTexture.SecureMode int getSecureModeV24(Context context) {
    ...
    return eglExtensions.contains(EXTENSION_SURFACELESS_CONTEXT)
        ...
        : EGLSurfaceTexture.SECURE_MODE_PROTECTED_PBUFFER;
  }
  ...
  private static class DummySurfaceThread extends HandlerThread implements Callback {
    ...
    public DummySurface init(@EGLSurfaceTexture.SecureMode int secureMode) {
      start();
    ...
    private void initInternal(@EGLSurfaceTexture.SecureMode int secureMode) {
