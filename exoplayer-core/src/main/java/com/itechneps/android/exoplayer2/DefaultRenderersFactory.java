...
import com.itechneps.android.exoplayer2.audio.AudioCapabilities;
import com.itechneps.android.exoplayer2.audio.AudioProcessor;
import com.itechneps.android.exoplayer2.audio.AudioRendererEventListener;
import com.itechneps.android.exoplayer2.audio.MediaCodecAudioRenderer;
...
import com.itechneps.android.exoplayer2.metadata.MetadataRenderer;
import com.itechneps.android.exoplayer2.text.TextOutput;
import com.itechneps.android.exoplayer2.text.TextRenderer;
import com.itechneps.android.exoplayer2.trackselection.TrackSelector;
import com.itechneps.android.exoplayer2.util.Log;
import com.itechneps.android.exoplayer2.video.MediaCodecVideoRenderer;
import com.itechneps.android.exoplayer2.video.VideoRendererEventListener;
import com.itechneps.android.exoplayer2.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  /**
   * Allow use of extension renderers. Extension renderers are indexed after exoplayer-core renderers of the
   * same type. A {@link TrackSelector} that prefers the first suitable renderer will therefore
   * prefer to use a exoplayer-core renderer to an extension renderer in the case that both are able to play
   * a given track.
   */
  public static final int EXTENSION_RENDERER_MODE_ON = 1;
  /**
   * Allow use of extension renderers. Extension renderers are indexed before exoplayer-core renderers of the
   * same type. A {@link TrackSelector} that prefers the first suitable renderer will therefore
   * prefer to use an extension renderer to a exoplayer-core renderer in the case that both are able to play
   * a given track.
   */
