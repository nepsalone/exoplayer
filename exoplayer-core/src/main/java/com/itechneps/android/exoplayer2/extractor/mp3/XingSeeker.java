...
/* package */ final class XingSeeker implements Mp3Extractor.Seeker {
  ...
  public SeekMap.SeekPoints getSeekPoints(long timeUs) {
    if (!isSeekable()) {
      return new SeekMap.SeekPoints(new SeekPoint(0, dataStartPosition + xingFrameSize));
    }
    ...
    return new SeekMap.SeekPoints(new SeekPoint(timeUs, dataStartPosition + positionOffset));
  }
