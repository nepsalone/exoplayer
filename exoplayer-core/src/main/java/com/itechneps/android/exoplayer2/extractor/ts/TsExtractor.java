 ...
 */
package com.itechneps.android.exoplayer2.extractor.ts;
...
import com.itechneps.android.exoplayer2.util.ParsableBitArray;
  ...
  private class PmtReader implements SectionPayloadReader {
    ...
    public void consume(ParsableByteArray sectionData) {
      ...
      if (mode == MODE_HLS && id3Reader == null) {
        ...
        TsPayloadReader.EsInfo dummyEsInfo = new TsPayloadReader.EsInfo(TS_STREAM_TYPE_ID3, null, null, Util.EMPTY_BYTE_ARRAY);
