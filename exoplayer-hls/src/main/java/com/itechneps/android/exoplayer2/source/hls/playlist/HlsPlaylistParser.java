 ...
 */
package com.itechneps.android.exoplayer2.source.hls.playlist;
...
import com.itechneps.android.exoplayer2.extractor.mp4.PsshAtomUtil;
import com.itechneps.android.exoplayer2.source.UnrecognizedInputFormatException;
...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
  ...
  private static @Nullable DrmInitData.SchemeData parsePlayReadySchemeData(
  ...
  private static @Nullable DrmInitData.SchemeData parseWidevineSchemeData(
    ...
    if (KEYFORMAT_WIDEVINE_PSSH_JSON.equals(keyFormat)) {
      try {
        return new DrmInitData.SchemeData(C.WIDEVINE_UUID, "exoplayer-hls", line.getBytes(C.UTF8_NAME));
